...
return [
    ...
    [ // $dynamicRoutes
        ...
        69 => [[['_route' => 'update_phone', '_controller' => 'App\\Controller\\ApiController::update'], ['id'], ['PUT' => 0], null, false, true, null]],
        ...
        599 => [[['_route' => 'partenaire_show', '_controller' => 'App\\Controller\\PartenaireController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        612 => [[['_route' => 'partenaire_edit', '_controller' => 'App\\Controller\\PartenaireController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        620 => [
